...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 < %s | FileCheck %s -check-prefix=ISA
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=gfx1010 -stop-before=si-fix-sgpr-copies < %s | FileCheck %s -check-prefix=MIR
...
; ISA-NEXT:    v_cmp_lt_i32_e32 vcc_lo, 0, v0
; ISA-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; ISA-NEXT:    v_mov_b32_e32 v3, 0
; ISA-NEXT:    v_cndmask_b32_e64 v7, 0, -1, vcc_lo
; ISA-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v7
...
; ISA-NEXT:    v_mov_b32_e32 v7, v3
; ISA-NEXT:    s_and_b32 s5, exec_lo, vcc_lo
; ISA-NEXT:    s_xor_b32 s6, exec_lo, s5
; ISA-NEXT:    s_or_b32 s4, s4, s6
; ISA-NEXT:    v_add_f32_e32 v3, v7, v0
; ISA-NEXT:    v_add_f32_e32 v3, v3, v4
; ISA-NEXT:    v_add_f32_e32 v3, v3, v5
; ISA-NEXT:    v_add_f32_e32 v3, v3, v6
