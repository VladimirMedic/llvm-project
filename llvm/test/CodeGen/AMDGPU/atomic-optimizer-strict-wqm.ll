...
; GFX10-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX10-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 1, v1
; GFX10-NEXT:    v_cmp_ne_u32_e64 s0, 1, v0
...
; GFX10-NEXT:    s_and_b32 s1, exec_lo, s0
; GFX10-NEXT:    s_xor_b32 s5, exec_lo, s1
...
; GFX10-NEXT:    s_or_b32 s3, s3, s1
; GFX10-NEXT:    s_xor_b32 s1, exec_lo, s3
; GFX10-NEXT:    s_and_b32 s1, s1, exec_lo
; GFX10-NEXT:    s_or_b32 s8, s8, s1
