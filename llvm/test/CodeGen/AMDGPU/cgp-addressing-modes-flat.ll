...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -mcpu=bonaire < %s | FileCheck --check-prefix=GFX7 %s
...
; GFX7-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
...
; GFX8-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
...
; GFX7-NEXT:    buffer_load_dword v4, v[2:3], s[8:11], 0 addr64 offset:28
