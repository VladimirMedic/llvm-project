...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn-- -mcpu=tahiti < %s | FileCheck %s
...
; CHECK-NEXT:    s_and_b64 s[4:5], exec, s[0:1]
; CHECK-NEXT:    s_xor_b64 s[0:1], s[0:1], -1
; CHECK-NEXT:    s_and_b64 s[4:5], s[0:1], exec
; CHECK-NEXT:    s_xor_b64 s[0:1], exec, s[4:5]
